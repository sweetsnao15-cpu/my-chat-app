...
export default function GuestPage() {
  ...
  return (
    <div style={{ width: '100%', height: '100dvh', display: 'flex', flexDirection: 'column', background: '#000', color: '#fff', overflow: 'hidden', fontFamily: 'serif' }}>
      ...
      {/* ヘッダー：高さを出し、ロゴを大きく修正 */}
      <header style={{ 
        padding: '35px 15px', background: '#600000', borderBottom: '1px solid #D4AF37', 
        textAlign: 'center', flexShrink: 0, zIndex: 10, boxShadow: '0 4px 10px rgba(0,0,0,0.5)'
      }}>
        <h1 style={{ 
          fontSize: '1.8rem', fontStyle: 'italic', fontWeight: 'bold', 
          margin: 0, letterSpacing: '5px', color: '#fff', textShadow: '2px 2px 4px rgba(0,0,0,0.5)'
        }}>
          for VAU
        </h1>
      </header>
